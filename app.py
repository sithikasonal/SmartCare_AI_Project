...
# White & Light Blue Circular Radial Meter with Rounded Edges
def create_circular_meter(probability_val):
  ...
  # 1. Background Soft Track Ring (Faint Transparent Ring)
  fig.add_trace(
      go.Pie(
          values=[100],
          hole=0.82,
  ...
  # 2. Outer Ring: Light Blue Gradient (Soft Light Blue Accent)
  fig.add_trace(
      go.Pie(
          values=[risk_percent, 100 - risk_percent],
          hole=0.74,
          marker=dict(colors=["#38bdf8", "rgba(0,0,0,0)"]),  # Light Blue
          hoverinfo="none",
          textinfo="none",
          direction="clockwise",
          rotation=90,
  ...
  # 3. Inner Ring: Solid Crisp White Ring
  fig.add_trace(
      go.Pie(
          values=[attend_percent, 100 - attend_percent],
          hole=0.58,
          marker=dict(colors=["#ffffff", "rgba(0,0,0,0)"]),  # Pure White
          hoverinfo="none",
          textinfo="none",
          direction="clockwise",
          rotation=90,
  ...
  fig.update_layout(
      annotations=[
          dict(
              ...
              x=0.5,
              y=0.5,
              font=dict(size=40, color="#FFFFFF", family="Plus Jakarta Sans"),
              showarrow=False,
          )
      ],
      height=320,
